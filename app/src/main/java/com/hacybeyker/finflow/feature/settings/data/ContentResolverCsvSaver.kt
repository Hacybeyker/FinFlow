 ...
 */
class ContentResolverCsvSaver @Inject constructor(@param:ApplicationContext private val context: Context) :
    CsvSaver {

    override suspend fun save(destinationUri: String, content: String): Boolean = withContext(Dispatchers.IO) {
        runCatching {

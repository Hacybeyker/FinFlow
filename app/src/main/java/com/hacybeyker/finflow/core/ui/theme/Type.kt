...
/**
 * Full Material 3 type scale. Defining the whole scale (not just bodyLarge) keeps hierarchy
 * consistent: screens pick a role (`titleLarge`, `bodyMedium`, ...), never a raw `fontSize`.
 * Amounts/figures should use the `*Medium`/`title` weights for emphasis.
 */
